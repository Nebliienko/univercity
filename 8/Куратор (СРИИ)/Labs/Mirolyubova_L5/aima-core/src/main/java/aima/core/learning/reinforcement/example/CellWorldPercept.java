 ...
 * environments. Note: The getCell() and setCell() methods allow a single percept
 * to be instantiated per agent within the environments. However, if an agent
...
public class CellWorldPercept implements PerceptStateReward<Cell<Double>> {
	 ...
	 * 
	 * @param cell
	 *            the cell within the environments that the percept refers to.
	 */
	...
	/**
	 * 
	 * @return the cell within the environments that the percept refers to.
	 */
	...
	/**
	 * Set the cell within the environments that the percept refers to.
	 * 
	 * @param cell
	 *            the cell within the environments that the percept refers to.
	 */
