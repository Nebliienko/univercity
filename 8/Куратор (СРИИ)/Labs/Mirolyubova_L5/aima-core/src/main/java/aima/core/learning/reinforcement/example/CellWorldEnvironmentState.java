...
public class CellWorldEnvironmentState implements EnvironmentState {
	...
	/**
	 * Reset the environments state to its default state.
	 */
	public void reset() {
	...
	/**
	 * Set an agent's location within the cell world environments.
	 * 
	 * @param anAgent
	 *            the agents whose location is to be tracked.
	 * @param location
	 *            the location for the agent in the cell world environments.
	 */
	...
	/**
	 * Get the location of an agent within the cell world environments.
	 * 
	 * @param anAgent
	 *            the agent whose location is being queried.
	 * @return the location of the agent within the cell world environments.
	 */
