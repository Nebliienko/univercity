...
import aima.core.agent.percept.DynamicPercept;

/**
 * Represents a local percept in the vacuum environments (i.e. details the
...
public class LocalVacuumEnvironmentPercept extends DynamicPercept {
	...
	/**
	 * Construct a vacuum environments percept from the agent's perception of the
	...
	/**
	 * Determine whether this percept matches an environments state
	 * 
	 * @param state
	 * @param agent
	 * @return true of the percept matches an environments state, false otherwise.
	 */
